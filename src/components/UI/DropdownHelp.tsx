...
function DropdownHelp({ align }: any) {
	...
	return (
		<div className="relative inline-flex">
			<button
				ref={trigger}
				className={`w-8 h-8 mr-5 flex items-center justify-center bg-gray-100 hover:bg-gray-200 transition duration-150 rounded-full ${
			...
			>
				...
				>
					...
					<ul>
						<li>
							<Link
								className="font-medium text-sm text-accent hover:font-bold flex items-center py-1 px-3"
								to="#0"
								onClick={() => setDropdownOpen(!dropdownOpen)}
							>
								<svg
						...
						<li>
							...
							>
								<svg
									className="w-3 h-3 fill-current text-accent flex-shrink-0 mr-2"
									viewBox="0 0 12 12"
								>
