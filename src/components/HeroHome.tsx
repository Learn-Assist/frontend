        ...
        <div>
            <div className="hero py-12 bg-transparent">
                <div className="absolute top-16 left-0 h-full w-full">
                    <div className="bubbles">{array.map(i => <div className="bubble" />)}</div>
                </div >
                <div className="flex-col hero-content">
                    <div className="text-center">
                        <h1 className="mb-5 text-6xl font-extrabold text-transparent bg-clip-text bg-gradient-to-br from-primary to-secondary">
                    ...
                    <img src={kids} className="max-w-screen  rounded-lg shadow-2xl" alt="l" />
                </div>
            </div>
            <div className="hero py-12 bg-base-200"><Phone /></div>
